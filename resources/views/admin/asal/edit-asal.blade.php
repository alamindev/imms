...
<div class="card">
    <div class="card-header bg-primary">
        <p class="float-left text-light">Edit Asal</p>
        <a class="btn btn-danger waves-effect float-right" href="{{ route('asals') }}">all asal</a>
    </div>
    <form class="form-horizontal" method="POST" action="{{ route('asal_update') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="card-content">  
                 <div class="form-group {{ $errors->has('daripada') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="daripada" class="form-control" name="daripada" value="{{ $editAsal->daripada }}"  placeholder="SINMAH LIVESTOCKS SDN BHD">
                    <input type="hidden" class="form-control" name="asal_id" value="{{ $editAsal->id }}">
                    <input type="hidden" id="employee_id" class="form-control" name="employee_id" value="{{ $editAsal->employee_id}}">
                ...
                <div class="form-group {{ $errors->has('perniagaan') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="perniagaan" class="form-control" name="perniagaan" value="{{ $editAsal->perniagaan }}" placeholder="58163-W">
                     <span class='text-danger'>{{ $errors->has('perniagaan')? $errors->first('perniagaan') : '' }}</span> 
                </div>     
                <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                    <label for="alamat">Alamat<span class="text-danger">*</span></label>
                    <input type="text" id="alamat" class="form-control" name="alamat" value="{{ $editAsal->alamat }}" placeholder="">
                ...
                <div class="form-group {{ $errors->has('im') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="im" class="form-control" name="im" value="{{ $editAsal->im }}" placeholder="(IM. 199-PIN. 1/10)">
                ...
                <div class="form-group {{ $errors->has('no_resit') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="no_resit" class="form-control" name="no_resit" value="{{ $editAsal->no_resit }}" placeholder="M01G066944">
              ...
              <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="date" class="form-control" name="date" value="{{ $editAsal->datetime }}">
            ...
            <div class="form-group {{ $errors->has('ringgit') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="ringgit" class="form-control" name="ringgit" value="{{ $editAsal->ringgit }}" placeholder="SATU RIBU ENAM RATUS EMPAT PULUH">
            ...
            <div class="form-group {{ $errors->has('bayaran_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="bayaran_name" class="form-control" name="bayaran_name" value="{{ $editAsal->bayaran_name }}" placeholder="BANK DRAF">
            ...
            <div class="form-group {{ $errors->has('bayaran_number') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="bayaran_number" class="form-control" name="bayaran_number" value="{{ $editAsal->bayaran_number }}" placeholder="BANK DRAF NUMBER 712787">
            ...
            <div class="form-group">
                    ...
                    <input type="text" id="notis_makluman" class="form-control" name="notis_makluman" value="{{ $editAsal->notis_makluman }}" placeholder="NOTIS"> 
            </div>  
            <div class="form-group {{ $errors->has('ptj') ? 'has-error' : '' }}">
                    <label for="ptj">PTJ<span class="text-danger">*</span></label>
                    <input type="text" id="ptj" class="form-control" name="ptj" value="{{ $editAsal->ptj }}" placeholder="060100-PEJ. IMM.MELAKA">
            ...
            <div class="form-group {{ $errors->has('mashana_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="mashana_name" class="form-control" name="mashana_name" value="{{ $editAsal->mashana_name }}" placeholder="MASHANA ">
            ...
            <div class="form-group {{ $errors->has('mashana_no') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="mashana_no" class="form-control" name="mashana_no" value="{{ $editAsal->mashana_no }}" placeholder="337">
          ...
          <div class="form-group {{ $errors->has('n_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="n_name" class="form-control" name="n_name" value="{{ $editAsal->n_name }}" placeholder="n">
             ...
             <div class="form-group {{ $errors->has('n_number') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="n_number" class="form-control" name="n_number" value="{{ $editAsal->n_number }}" placeholder="828670">
        ...
        <div class="form-group {{ $errors->has('kelulusan') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kelulusan" class="form-control" name="kelulusan" value="{{ $editAsal->kelulusan }}" placeholder="BPKS(8.15)248-11(43)">
                     <span class='text-danger'>{{ $errors->has('kelulusan')? $errors->first('kelulusan') : '' }}</span> 
            </div> 
                
     </div> 
    <div class="card-footer">
       <button type="submit" class="btn btn-success">Update asal</button>
    </div>
</form>
</div>
@endsection
